...
/*
  ...
  'D', 
  and 
  anything below 60 should console log an 
  'F'.
*/
...
// Use an
//if statement to check the length of the 'myFavoriteNumbers' array.
...
if (myFavoriteNumbers.length < 7) {
  ...
  console.log("You've got exactly 7");
}
...
//checking to see
//if each number is divisible by 3.
...
/* Use a switch statement on 'letterGrade' 
and console.log the appropriate response.
...
switch (letterGrade) {
  case `A`:
    console.log(`Student is doing excellent`);
    break;
  case `B`:
    console.log(`Student is doing well`);
    break;
  case `C`:
    console.log(`Student is doing alright`);
    break;
  case `D`:
    console.log(`Student is not doing very well`);
    break;
  case `F`:
